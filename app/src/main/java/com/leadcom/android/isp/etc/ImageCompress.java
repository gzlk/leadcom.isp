...
//        return bitmap;
    ...
    private static void compress(String fromPath, String toPath, int prepareToWidth, int prepareToHeight) throws IOException {
        ...
        log(String.format(Locale.getDefault(), "try to compress image %s, %dx%d to %dx%d, scale 1/%d, to %s",
                fromPath, options.outWidth, options.outHeight, prepareToWidth, prepareToHeight, sampleSize, toPath));
