...
/**
 * <b>功能描述：</b>用于RecyclerView的滑动删除类(一次只能滑出一个，另外再滑出时需要先关闭已打开的item)<br />
 * <b>创建作者：</b>Hsiang Leekwok <br />
 * <b>创建时间：</b>2018/04/05 18:07 <br />
 ...
 * <b>修改备注：</b><br />
 */
public class SwipeItemLayoutPlus extends ViewGroup {
    ...
    public SwipeItemLayoutPlus(Context context) {
        this(context, null);
    }

    public SwipeItemLayoutPlus(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private class ScrollRunnable implements Runnable {
        ...
        void startScroll(int startX, int endX) {
            if (startX != endX) {
                ...
                ViewCompat.postOnAnimation(SwipeItemLayoutPlus.this, this);
            }
        }
    ...
    public static class OnSwipeItemTouchListener implements RecyclerView.OnItemTouchListener {
        private SwipeItemLayoutPlus captureItem;
        ...
        public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent ev) {
            ...
            switch (action) {
                case MotionEvent.ACTION_DOWN: {
                    ...
                    SwipeItemLayoutPlus pointItem = null;
                    //首先知道ev针对的是哪个item
                    View pointView = findTopChildUnder(rv, (int) x, (int) y);
                    if (pointView == null || !(pointView instanceof SwipeItemLayoutPlus)) {
                        //可能是head view或bottom view
                        pointOther = true;
                    } else
                        pointItem = (SwipeItemLayoutPlus) pointView;
