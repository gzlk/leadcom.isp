                ...
                case R.id.ui_holder_view_individual_user_message_info:
                    ...
                    switch (msg.getSourceType()) {
                        ...
                        default:
                            ...
                            ArchiveDetailsWebViewFragment.open(UserMessageFragment.this, StringHelper.getString(R.string.ui_text_archive_details_fragment_title), Archive.ArchiveType.MULTIMEDIA, msg.getSourceId());
                            break;
                    }
                    break;
