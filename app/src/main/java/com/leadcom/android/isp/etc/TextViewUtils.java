...
/**
 * <b>功能描述：</b>TextView 方法集合<br />
 * <b>创建作者：</b>Hsiang Leekwok <br />
 * <b>创建时间：</b>2018/09/01 12:30 <br />
...
public class TextViewUtils {
    ...
    @Nullable
    public static ValueAnimator setMaxLinesWithAnimation(@NonNull final TextView textView, final int maxLine) {
    ...
    @Nullable
    public static ValueAnimator animatorToHeight(@NonNull final TextView textView, int h, @Nullable Animator.AnimatorListener listener) {
    ...
    public static int measureTextHeight(@NonNull TextView textView, @NonNull CharSequence text) {
    ...
    public static int measureTextHeight(@NonNull TextView textView, @NonNull CharSequence text, int maxLines) {
    ...
    public static int measureTextHeight(@NonNull TextView textView, @NonNull CharSequence text, @NonNull TextPaint textPaint, int maxLines) {
