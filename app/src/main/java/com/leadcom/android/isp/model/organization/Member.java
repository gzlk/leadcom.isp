...
public class Member extends Leaguer {
    ...
    public interface Code {
        ...
        String GROUP_ROLE_CODE_MANAGER_FINANCE = "f43c7aedfe22410ea885e707aa79ac6b";// 组织管理员兼财务
        String GROUP_ROLE_CODE_FINANCE = "f43c7aedfe22410ea885e707aa79ac6c";        // 组织财务
        ...
        String GROUP_ROLE_CODE_SQUAD_MANAGER_FINANCE = "b76a597176ba465e8fd306bb91cb7f3d";  // 小组管理员兼财务
        String GROUP_ROLE_CODE_SQUAD_FINANCE = "b76a597176ba465e8fd306bb91cb7f3e";  // 小组财务
...
//        return false;
    ...
    public boolean isFinance() {
        return null != getGroRole() && getGroRole().isFinance();
    }
    ...
    public boolean isSquadFinance() {
        return null != getGroRole() && getGroRole().isSquadFinance();
    }
