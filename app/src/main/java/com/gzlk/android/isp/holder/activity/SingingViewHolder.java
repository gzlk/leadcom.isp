...
public class SingingViewHolder extends BaseViewHolder {
    ...
    public void showContent(AppSigning signing) {
        ...
        timeView.setText(Utils.formatTimeAgo(signing.getCreateDate(), StringHelper.getString(R.string.ui_base_text_date_time_format)));
    }

    public void showContent(AppSignRecord record) {
        iconView.setText(R.string.ui_icon_location);
        titleView.setText(record.getCreatorName());
        timeView.setText(Utils.formatTimeAgo(record.getCreateDate(), StringHelper.getString(R.string.ui_base_text_date_time_format)));
        descView.setText(record.getAddress());
    }
}
